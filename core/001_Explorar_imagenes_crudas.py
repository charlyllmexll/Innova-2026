...
DIR_IMAGENES_CRUDAS = "data/imagenes_crudas"  # Carpeta donde el operador mete las fotos del dron
DIR_REPORTES        = "data/reports"          # Nueva carpeta ordenada para las auditorías de texto
