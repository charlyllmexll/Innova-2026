...
RUTA_MODELO_SAM    = os.path.join(RUTA_BASE_PROYECTO, "models", "sam_vit_h_4b8939.pth")
...
mask_generator = SamAutomaticMaskGenerator(
    model=sam,
    points_per_side=32,           # Sube el muestreo a 4,096 puntos (Antes 32/1,024) para pencas finas
